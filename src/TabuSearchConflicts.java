...
//
//        while(timetable.objFunc > 0) {
//
//            TabuMove bestMove = generatesBestNeighbour2(timetable,tabulist,rep);
//
//            if(bestMove==null) {
//				/*
...
//     * */
//    private TabuMove generatesBestNeighbour2(Timetable timetable, int [][] G, TabuList tabulist,int rep){
//
...
//        for(int i=0;i<rep;i++) {
//
//            TabuMove move = generatesNeighbour2(timetable,tabulist,bestConflictNumber,randConflict,randExam,randTimeslot);
//
...
//     * */
//    private TabuMove generatesNeighbour2(Timetable timetable, TabuList tabulist, int bestConflictsNumber,Random randConflict, Random randExam, Random randTimeslot) {
//
//        TabuMove moving;
//
//        for(;;) {
