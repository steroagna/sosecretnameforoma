...
public class TabuSearchPenalty {
    ...
    public Timetable TabuSearch(Timetable timetable, Data data, int rep, long timer) {
        ...
        timetable.penalty /= timetable.data.studentsNumber;
        bestTimetable = new Timetable(timetable);
        
        bestMinPenalty = timetable.penalty;
        ...
        while (improvementTimer < timer) {
            ...
            timetable.penalty = Util.ofCalculator(timetable, data);
...
//        }
    ...
    private void updateBest(Timetable timetable, Data data) {
        if (timetable.penalty < bestTimetable.penalty) {
            bestTimetable = new Timetable(timetable);
            improvementDelta = lastBestPenalty - bestTimetable.penalty;
            lastBestPenalty = bestTimetable.penalty;
